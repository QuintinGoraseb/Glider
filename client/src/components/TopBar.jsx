...
export default function TopBar() {
    return(
        <header className="mx-10 sm:mx-20">
            ...
            <hr
            className="relative mb-0 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-100 to-transparent opacity-25 dark:opacity-100"/>
        </header>
    );
}