    ...
    return(
        <section className="section">
            <div className="container mx-auto text-justify px-10">
                <h2 className="text-xl sm:h2 text-primary lg:pb-6">Glider site Privacy Policy</h2>
                <h3 className="text-lg sm:h3 text-[#c0c0c0] pb-4">Version 1.0</h3>

                <p>Last updated: June 12, 2024</p><br />
                ...
                <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Glider cc, 830 Samuel Maharero St. Academia.</p>
                </li>
                <li>
                <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
                </li>
                <li>
                <p><strong>Country</strong> refers to:  Namibia</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to Glider HR Consultants, accessible from <a href="https://www.glider.com.na" rel="external nofollow noopener" target="_blank">https://www.glider.com.na</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>
                <p>By email: info@glider.com.na</p>
                </li>
                <li>
                <p>By visiting this page on our website: <a href="www.glider.com.na" rel="external nofollow noopener" target="_blank">www.glider.com.na</a></p>
                </li>
                </ul>
            </div>
        </section>
